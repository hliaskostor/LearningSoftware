...
namespace LearningSoftware
{
    public partial class reviseQuiz : Form
    {
        ...
        public void checkAnswer()
        {
            ...
            answerCorrect.Add("ArrayList:Πίνακας μεταβλητού μεγέθους\nLinkedList:Διπλά συνδεδεμένη λίστα"); 
            answerCorrect.Add("[Java,Java,Java]");
            answerCorrect.Add("(1)Animal\n(2)eat\n(3)travel"); 
        ...
        private void LoadQuestion()
        {
            switch (qnum)
            {
                ...
                case 6:
                    ...
                    pictureBox1.Size = new Size(547, 270);
                    pictureBox1.Location = new Point(172, 12);
                    button1.Location = new Point(72, 368);
                ...
                case 10:
                    ...
                    button3.Visible = true;
                    button4.Visible = true;
                    pictureBox1.Size = new Size(500, 450);
                    pictureBox1.Visible = true;
